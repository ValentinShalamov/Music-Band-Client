...
public class MessagesByMistakes {
    public static final String NAME_IS_EMPTY = "The name of band can't be empty \n";
    public static final String NAME_IS_NUMBER = "The name of band can't be any number \n";
    ...
    public static final String NUMBER_OF_PARTICIPANTS_IS_DOUBLE = "The number of participants can't be fractional \n";
    public static final String NUMBER_OF_PARTICIPANTS_IS_NOT_INTEGER = "The number of participants should be more than zero \n";
    public static final String NUMBER_OF_PARTICIPANTS_LESS_THAN_ONE = "The number of participants should be more than zero \n";
    ...
    public static final String BEST_ALBUM_IS_NUMBER = "The name of the best album can't be any number \n";
